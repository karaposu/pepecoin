...
class OrdersListResponse(BaseModel):
    ...
    total_count: Optional[StrictInt] = Field(default=None, description="Total number of orders available")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "orders": [OrderResponse.from_dict(_item) for _item in obj.get("orders")] if obj.get("orders") is not None else None,
